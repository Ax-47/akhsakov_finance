            ...
            div { class: "flex items-start justify-between mb-6 gap-4",
                div {
                    div { class: "flex items-center gap-3 mb-1",
                        div {
                            style: "width:4px;height:28px;border-radius:2px;\
                        ...
                        table { class: "w-full text-xs",
                            thead {
                                tr { class: "border-b border-ctp-surface1 text-ctp-overlay0",
                                    ...
                                    th { class: "px-4 py-2.5 text-right font-semibold uppercase tracking-wider", "Total Cost"    }
                                    th { class: "px-4 py-2.5 text-right font-semibold uppercase tracking-wider", "Market Value"    }
                            ...
                            div { class: "mt-4 flex flex-col gap-2",
                                for (i, (ticker, pct)) in allocation.iter().enumerate() {
                                    div {
                                        ...
                                        div { class: "flex items-center gap-2",
                                            div {
                                                style: "height:4px;width:{(pct * dec!(0.6)).round():.0}px;\
...
fn StatCard(label: String, value: String, sub: String, color: String, icon: String) -> Element {
    rsx! {
        div {
            ...
            span {
                style: "position:absolute;top:-24px;right:-24px;width:90px;height:90px;\
